class config:
    BOT_TOKEN = "2027398956:AAGMXgB2oFwnLfazIn7FGt7MpMDCpgoYUaw
"
    APP_ID = "
4773639"
    API_HASH = "493cb7cb8428c5de4490ab47e936fb96"
    DATABASE_URL = "postgres://pwcevvahbacnno:2f778855231b2d53f07f41a7b378669045f4b415103efb2bb195d1d8c381cc6e@ec2-34-198-189-252.compute-1.amazonaws.com:5432/d8d93i4d55tek7"
    ...
    G_DRIVE_CLIENT_ID = "81975736079-o2vs2cfqmqhl1ino9qh2d90bsprqgndl.apps.googleusercontent.com"
    G_DRIVE_CLIENT_SECRET = "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"
...
class Messages:
    ...
    HELP_MSG = [
        ...
        "**Rules & Precautions**\n__1. Don't copy BIG Google Drive Files/Folders. only for THARSHIKAN.\n2. Send One request at a time unless bot will stop all processes.\n3. Don't send slow links @transload it first.\n4. Don't misuse, overload or abuse this free service.__",
        
        # Dont remove this ↓ if you respect developer.
        "**Developed by @official_account_verification**"
        ]
     
    RATE_LIMIT_EXCEEDED_MESSAGE = "❗ **Rate Limit Exceeded DO YOU FUCK MY BOT.**\n__User rate limit exceeded try after 24 hours.__"
    ...
    UPLOADED_SUCCESSFULLY = "✅ **Uploaded Successfully I am tharshikan .**\n[{}]({}) __({})__"
    
    DOWNLOAD_ERROR = "❗**Downloader Failed**\n{}\n__Link - {}__"
    
    DOWNLOADING = "📥 **Downloading File to my drive...\nLink:** ```{}```"
    
    ALREADY_AUTH = "🔒 **Already authorized your Google Drive Account.**\n__Use /revoke to revoke the current account.__\n__Send me a direct link or File to Upload on Google Drive__"
    
    FLOW_IS_NONE = f"❗ **Invalid Code**\n__Run {BotCommands.Authorize[0]} first.__"
    
    AUTH_SUCCESSFULLY = '🔐 **Authorized Google Drive account Successfully Thank you for using me.**'
    ...
    DOWNLOAD_TG_FILE = "📥 **Downloading File to upload https://pjalwalsindex.priyanshujalwal.workers.dev/...**\n**Filename:** ```{}```\n**Size:** ```{}```\n**MimeType:** ```{}```"
